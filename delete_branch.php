...
//    if(isset($_POST['b_id'])){
    ...
    $sql= "DELETE FROM `branch` WHERE `branch`.`b_id`='$b_id'";
    ...
    // if($result == TRUE){
       ...
       header("Refresh:2; url=view_branch.php");
      // mysqli_close($conn);
...
background-repeat: no-repeat;line-height:2.9">
 ...
 <h2 align="center" style= "color:rgb(255, 255, 255); font-size:85px; font-family:Gill Sans MT;line-height:2.9;">BRANCH DELETE</h2>
